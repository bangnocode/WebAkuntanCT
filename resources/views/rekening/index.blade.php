            ...
            <form action="{{ route('rekening.store') }}" method="POST"
                ...
                <div class="lg:col-span-1">
                    ...
                    <input type="text" name="KODER" required
                        class="w-full text-sm rounded-sm border border-gray-300 bg-white py-2 px-3 text-gray-700 placeholder-gray-400
              ...
              py-2 px-3 text-gray-700 placeholder-gray-400 text-sm
              focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 
              hover:border-blue-300 transition-all duration-200"
               ...
               appearance-none cursor-pointer">
                ...
                <div class="lg:col-span-1">
                    ...
                    <input type="number" name="SALDO" value="0" required min="0"
                        class="w-full rounded-sm border border-gray-300 bg-white 
