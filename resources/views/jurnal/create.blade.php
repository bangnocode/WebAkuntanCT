...
@section('content')
    <div x-data="jurnalApp()" class="flex flex-col h-screen bg-gray-50">
        <!-- HEADER & CART TABLE -->
        <div class="flex-grow overflow-auto space-y-2 sm:space-y-3 pb-[280px] sm:pb-[200px]">
            <!-- Header Summary -->
        ...
        <div class="fixed bottom-0 left-0 md:left-64 right-0 bg-white border-t shadow-lg z-10">
            <div class="p-4 space-y-2 max-w-screen-2xl mx-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-8 gap-2">
                  ...
                  transition-all duration-200 ease-in-out bg-white font-mono shadow-sm">
                    ...
                    <div class="sm:col-span-2 hidden sm:block">
                        <label class="text-xs text-gray-500 font-semibold block mb-1">Nominal</label>
                ...
                <div class="grid grid-cols-2 gap-2 sm:hidden">
                    <div>
                        <label class="text-[10px] text-gray-500 font-semibold block mb-1">Nominal</label>
